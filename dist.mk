# $Id: dist.mk,v 1.189 2000/03/12 03:10:52 juergen Exp $
...
manhtml: MANIFEST
	...
	@sort < MANIFEST.tmp > MANIFEST
	@rm -f MANIFEST.tmp

#
# Please note that this target can only be properly build if the
# build of the Ada95 subdir has been done. The reason is, that
# the gnathtml tool uses the .ali files generated by the Ada95
# compiler during the build process. These .ali files contain
# cross referencing information required by gnathtml.
adahtml: MANIFEST
	if [ ! -z "$(GNATHTML)" ]; then \
