...
include(`Field_Rep')
   ...
   Default_Field_Options : constant Field_Option_Set;
   --  The initial defaults for the field options.

include(`Form_Opt_Rep')

   Default_Form_Options : constant Form_Option_Set;
   ...
   pragma Controlled (Field_Array_Access);
   ...
   procedure Switch_Options (Fld     : in Field;
                             Options : in Field_Option_Set;
                             On      : Boolean := True);
   --  AKA: field_opts_on(), field_opts_off()
   ...
   procedure Switch_Options (Frm     : in Form;
                             Options : in Form_Option_Set;
                             On      : Boolean := True);
   --  AKA: form_opts_on(), form_opts_off()
   ...
   pragma Controlled (Field_Type_Access);
   ...
   --  AKA: field_type() and field_arg()
   --  In Ada95 we can combine these easily
...
private
   ...
   Default_Field_Options : constant Field_Option_Set :=
     Get_Options (Null_Field);

   Default_Form_Options : constant Form_Option_Set :=
     Get_Options (Null_Form);
