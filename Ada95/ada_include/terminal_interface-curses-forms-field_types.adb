...
package body Terminal_Interface.Curses.Forms.Field_Types is
   ...
   type C_Check is access
      function (Ch : Character; Info : User_Access) return Boolean;
   ...
   function Fc (Fld : Field; Info : User_Access) return Boolean;
   pragma Convention (C, Fc);

   function Cc (Ch : Character; Info : User_Access) return Boolean;
   ...
   is
   begin
      return Field_Check (Fld, Info);
   end Fc;

   function Cc (Ch : Character; Info : User_Access) return Boolean
   is
   begin
      return Character_Check (Ch, Info);
   end Cc;
