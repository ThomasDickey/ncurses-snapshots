...
#
# ($Id: MKlib_gen.sh,v 0.1 1995/11/13 22:31:38 tom Exp $)
#
...
# any that don't have a `generated' comment attached. It thaen parses each
...
BEGIN		{
	print "/*"
	print " * DO NOI EDIT THIS FILE BY HAND!"
	...
	print " * function."
	print " *"
	print " * It will not ever be linked unless you call one of the entry"
